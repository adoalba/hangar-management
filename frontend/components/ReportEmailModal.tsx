...
const ReportEmailModal: React.FC<ReportEmailModalProps> = ({
    ...
    const getReportTypeLabel = () => {
        switch (reportData.reportType) {
            case 'TOTAL_INVENTORY': return t.report_total_inventory || 'Total Inventory';
            case 'BY_STATUS': return t.report_by_status || 'By Card Type';
            case 'BY_LOCATION': return t.report_by_location || 'By Location';
            case 'BY_PART_NUMBER': return t.report_by_pn || 'By Part Number';
    ...
    const handleSend = async () => {
        ...
        try {
            const endpoint = requireApproval
                ? '/api/reports/send-with-approval'
